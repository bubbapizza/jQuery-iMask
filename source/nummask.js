...
nummask = {
   ...
   stripMask : function(str) {
      ...
      for (var i = 0; i < str.length; i += 1) {
         ...
         } else if (str[i] == this.DECIMAL_CHR && allow_decimal_point) {
            output += str[i];
   ...
   splitNumStr : function(numStr) {
      ...
      numStr = this.stripMask(numStr);
   
      /* Figure out the integer and decimal portions of the number. */
      [intStr, decStr] = numStr.split(this.DECIMAL_CHR);
   ...
   splitNumMask : function(numMask) {
      ...
      /* Figure out the integer and decimal portions of the number. */
      [intMask, decMask] = numMask.split(this.DECIMAL_CHR);
   ...
   wearMask : function(numStr, mask) {
      ...
      /* Break the number and the mask into their respective integer and
         decimal portions */
      [intStr, decStr] = this.splitNumStr(numStr);
      [intMask, decMask] = this.splitNumMask(mask);
