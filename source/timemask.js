...
timemask = {
   ...
   newCursorPos : function(lastPos, chr, timeStr, mask) {
      ...
      /****
       *  For the finite state machines below, the column headers 
       *  represent the key pressed.  The row header, or dictionary
       *  key, is the current cursor position (aka the current state).
       ****/
